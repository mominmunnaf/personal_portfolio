    ...
    <div class="main-wrapper">
        ...
        <nav class="sidebar">
            <div class="sidebar-header">
                <a href="#" class="sidebar-brand">
                    <img src="{{ asset('backend/images') }}/stockape_logo.png" width="130px">
                </a>
            ...
            <div class="sidebar-body">
                <ul class="nav">
                    <li class="nav-item nav-category">Mominul Islam</li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#emails" role="button" aria-expanded="false"
                            ...
                            <span class="link-title">Projects</span><span class="badge badge-success ml-3">4</span>
                            <i class="link-arrow" data-feather="chevron-down"></i>
                        </a>
                        <div class="collapse" id="emails">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="pages/email/inbox.html" class="nav-link">All Projects</a>
                                </li>
                                <li class="nav-item">
        ...
        <nav class="settings-sidebar">
            <div class="sidebar-body">
                ...
                <div class="theme-wrapper">
                    ...
                    <a class="theme-item active" href="{{ asset('backend') }}/demo_2/dashboard-one.html">
        ...
        <div class="page-wrapper">
                            ...
                            <div class="dropdown-menu" aria-labelledby="messageDropdown">
                                ...
                                <div class="dropdown-body">
                                    <a href="javascript:;" class="dropdown-item">
                                        <div class="figure">
                                            <img src="{{ asset('backend/images') }}/1.png" alt="userr">
                                        </div>
                                        <div class="content">
            ...
            <footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
                <p class="text-muted text-center text-md-left">Use is subject to full acceptance of Terms of Use
                    and Privacy Policy, bar none.<br> Investing is risky and can result in huge losses.<br>
                    Information provided is not financial advice and<br> we do not warrant or guarantee the
                    contents<br> are accurate, up-to-date or reliable. </p>
                <p class="text-muted text-center text-md-left mb-0 d-none d-md-block">StockApe © <a
                        href="https://twitter.com/stock_ape"><img
                            src="https://img.icons8.com/color/48/000000/twitter--v2.png" /></a> <a
                        href="https://www.reddit.com/r/StockApeAI/"><img
                            src="https://img.icons8.com/windows/50/000000/reddit.png"
                            style="background-color: aliceblue;" /></a> </p>
            </footer>
            <!-- partial -->
